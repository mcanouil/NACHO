...
```{r logo, echo = FALSE, eval = TRUE, out.width = "150px"}
...
When the summarisation is done, the summarised data can be visualised using the `visualise()` function as can be seen in the following chunk of code.
