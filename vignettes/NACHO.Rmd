...
- name: "Mickaël Canouil, Ph.D."
  ...
  email: "***REMOVED***"
- name: "Gerard A. Bouland"
  affiliation: &id "Department of Cell and Chemical Biology, Leiden University Medical Center, 2333ZC, Leiden, The Netherlands"
- name: "Roderick C. Slieker, Ph.D."
  affiliation: 
    - *id
    - "Department of Epidemiology and Biostatistics, Amsterdam Public Health Institute, Amsterdam UMC, VU University Medical Center, Amsterdam, the Netherlands"
...
GSE70970_sum <- summarise(
  ...
  n_comp = 5
) # Number indicating the number of principal components to compute. 
```
