...
knitr::include_graphics(path = system.file("help", "figures", "nacho_hex.png", package = "NACHO"))
```
...
```{r ex1-fig}
knitr::include_graphics(path = system.file("help", "figures", "README-visualise.png", package = "NACHO"))
```
