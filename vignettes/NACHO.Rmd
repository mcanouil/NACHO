...
The raw data used in the summarisation is from a study of Liu MC et al. [@liu_pam50_2016] and was acquired from the NCBI GEO public database [@barrett_ncbi_2013].
...
In this example we use a mRNA dataset from the study of *Bruce* et al. [@bruce_identification_2015] with the GEO accession number: **GSE70970** [@barrett_ncbi_2013]. 
