...
The samples were measured with two versions of the miRNA CodeSet, and `load_rcc()` only accepts files from a single CodeSet.
...
codeset <- vapply(
  X = file.path(tempdir(), "GSE70970", "Data", targets$IDFILE),
