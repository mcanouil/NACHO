...
#   ) +
#   ggplot2::annotate(geom = "text", x = 1, y = 1, label = "NACHO", size = 24, colour = "grey25") +
#   ggplot2::scale_alpha_manual(values = c(0.95, 0.90, 0.80)*0.8) +
...
# ggplot2::ggsave(
#   filename = "/disks/PROJECT/Mickael/NACHO/inst/logo/nacho_hex_r.png",
#   plot = p,
#   bg = "transparent",
#   width = 1.73,
#   height = 2,
