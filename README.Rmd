...
```{r}
#| echo: false
#| fig-alt: "NACHO Shiny application in use."
...
```{r}
#| echo: false
#| fig-alt: "NACHO interactive dashboard showing quality-control plots for the GSE74821 dataset."
knitr::include_graphics("man/figures/README-visualise.png")
```
