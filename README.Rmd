...
* The `render()` function is used to render a full quality-control report (HTML) based on the results of a call to `summarise()` or `normalise()`.
* The `plot()` function is used to draw any quality-control metrics from `visualise()` and `render()`.
