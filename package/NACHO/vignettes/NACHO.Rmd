...
Let's say _BAG1_ and _MDM2_ are not suitable,therefore, you want to exclude these genes from the normalisation process.
...
The `normalise()` function has three dataframes as output; 1) **scaling**, 2) **normalised** and 3) **raw**. 
These dataframes can be accessed and used using.
